...
public class Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehiculos>().HasData(new List<Vehiculos>()
        {
            ...
            Marca ="Honda", Modelo ="CR-V", Tipo ="Jeepeta", Anio ="2021", Placa = "G520423", Precio = 6745, Existencia = 5,},
            new Vehiculos
            ...
            Marca ="Honda", Modelo ="Civic", Tipo ="Sedán", Anio ="2022", Placa = "J134998", Precio = 5340, Existencia = 5,},
            new Vehiculos
            ...
            Marca ="Isuzu", Modelo ="D-MAX", Tipo ="Camioneta", Anio ="2023", Placa = "H722423", Precio = 8950, Existencia = 5,},
            new Vehiculos
            {VehiculoId = 4, Imagen = "https://www.motortrend.com/uploads/2022/05/2023-Audi-A3-003-front-three-quarter-view.jpg",
            Marca ="Audi", Modelo ="A3 S-Line", Tipo ="Compacto", Anio = "2023", Placa = "A432539", Precio = 9500, Existencia = 4,},
            new Vehiculos
            {VehiculoId = 5, Imagen = "https://www.gravityautossandysprings.com/galleria_images/2185/2185_main_l.jpg",
            Marca ="Ford Mustang", Modelo ="PREMIUM", Tipo ="Deportivo", Anio ="2010", Placa = "E926184", Precio = 6700, Existencia = 3,},
            new Vehiculos
            {VehiculoId = 6, Imagen = "https://img.supercarros.com/AdsPhotos/500x500/0/9819611.jpg",
            Marca ="Hyundai", Modelo ="Sonata New Rise", Tipo ="Sedán", Anio ="2018", Placa = "T748510", Precio = 5000, Existencia = 3,},
            new Vehiculos
            ...
            Marca ="Mini", Modelo ="Cooper Countryman", Tipo ="Coupé/Deportivo", Anio ="2016", Placa = "A397148", Precio = 3000, Existencia = 1,},
        });
    }
}