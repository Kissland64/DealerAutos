...
public class Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehiculos>().HasData(new List<Vehiculos>()
        {
            ...
            Nombre ="Honda CR-V", Anio = new DateTime(2021), Placa = "G520423", Precio = 6745, Existencia = 2,},
            new Vehiculos
            ...
            Nombre ="Honda Civic", Anio = new DateTime(2022), Placa = "J134998", Precio = 5340, Existencia = 2,},
            new Vehiculos
            ...
            Nombre ="Isuzu D-MAX", Anio = new DateTime(2023), Placa = "H722423", Precio = 8950, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 4, Imagen = "https://www.motortrend.com/uploads/2022/05/2023-Audi-A3-003-front-three-quarter-view.jpg",
            Nombre ="Audi A3 S-Line", Anio = new DateTime(2023), Placa = "A432539", Precio = 9500, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 5, Imagen = "https://www.gravityautossandysprings.com/galleria_images/2185/2185_main_l.jpg",
            Nombre ="Ford Mustang PREMIUM", Anio = new DateTime(2010), Placa = "E926184", Precio = 6700, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 6, Imagen = "https://img.supercarros.com/AdsPhotos/500x500/0/9819611.jpg",
            Nombre ="Hyundai Sonata New Rise", Anio = new DateTime(2018), Placa = "T748510", Precio = 5000, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 7, Imagen = "https://espaillatmotors.com/wp-content/uploads/2023/02/1-10-scaled.jpg",
            Nombre ="SWM G01F", Anio = new DateTime(2023), Placa = "P426591", Precio = 7000, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 8, Imagen = "https://www.automotiveaddicts.com/wp-content/uploads/2020/11/2020-chevrolet-corvette.jpg",
            Nombre ="Chevrolet Corvette Stingray Z51", Anio = new DateTime(2020), Placa = "F102607", Precio = 9000, Existencia = 2,},
            new Vehiculos
            {VehiculoId = 9, Imagen = "https://cdn.motor1.com/images/mgl/YMkY0/s1/lanzamiento-kia-picanto-2018.jpg",
            Nombre ="Kia Picanto", Anio = new DateTime(2018), Placa = "B892415", Precio = 2000, Existencia = 2,},
            new Vehiculos
            ...
            Nombre ="Mini Cooper Countryman", Anio = new DateTime(2016), Placa = "A397148", Precio = 3000, Existencia = 2,},
        });
        modelBuilder.Entity<Marca>().HasData(new List<Marca>()
        {
            ...
            Nombre ="Honda", FechaCreacion = new DateTime(24-09-1948), Modelo = "CR-V", Tipo = "Jeepeta",},
            new Marca
            ...
            Nombre ="Honda", FechaCreacion = new DateTime(24-09-1948), Modelo = "Civic", Tipo = "Sedán",},
            new Marca
            {MarcaId = 3, Imagen = "https://logowik.com/content/uploads/images/562_audi.jpg",
            Nombre ="Audi", FechaCreacion = new DateTime(16-07-1909), Modelo = "A3 S-Line", Tipo = "Compacto",},
            new Marca
            {MarcaId = 4, Imagen = "https://www.carlogos.org/logo/Isuzu-logo-1974-3000x3000.png",
            Nombre ="Isuzu", FechaCreacion = new DateTime(10-11-1916), Modelo = "D-MAX", Tipo = "Camioneta",},
            new Marca
            {MarcaId = 5, Imagen = "https://img.remediosdigitales.com/437262/2009_ford_mustang_badge/450_1000.jpg",
            Nombre ="Ford Mustang", FechaCreacion = new DateTime(17-04-1964), Modelo = "PREMIUM", Tipo = "Deportivo",},
            new Marca
            {MarcaId = 6, Imagen = "https://memolira.com/wp-content/uploads/2020/08/1600px-Hyundai_26379413755-e1596664023773.jpg",
            Nombre ="Hyundai", FechaCreacion = new DateTime(29-12-1967), Modelo = "Sonata New Rise", Tipo = "Sedán",},
            new Marca
            ...
            Nombre ="SWM", FechaCreacion = new DateTime(11-06-1971), Modelo = "G01F", Tipo = "Jeepeta",},
            new Marca
            ...
            Nombre ="Chevrolet Corvette", FechaCreacion = new DateTime(13-01-2013), Modelo = "Stingray Z51", Tipo = "Deportivo",},
            new Marca
            {MarcaId = 9, Imagen = "https://www.wfla.com/wp-content/uploads/sites/71/2021/03/Kia.jpg?w=1280",
            Nombre ="Kia", FechaCreacion = new DateTime(11-12-1944), Modelo = "Picanto", Tipo = "Compacto",},
            new Marca
            {MarcaId = 10, Imagen = "https://img.remediosdigitales.com/f31872/logo-mini/450_1000.jpg",
            Nombre ="Mini", FechaCreacion = new DateTime(24-01-1969), Modelo = "Cooper Countryman", Tipo = "Coupé/Deportivo",},
        });
    }
}