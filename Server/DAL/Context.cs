...
public class Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehiculos>().HasData(new List<Vehiculos>()
        {
            ...
            Marca ="Audi", Modelo ="A3_S-Line", Tipo ="Compacto", Anio = "2023", Precio = 9500, Existencia = 5,},
            new Vehiculos
            {VehiculoId = 5, Imagen = "https://www.gravityautossandysprings.com/galleria_images/2185/2185_main_l.jpg",
            Marca ="Ford_Mustang", Modelo ="PREMIUM", Tipo ="Deportivo", Anio ="2010", Precio = 6700, Existencia = 5,},
            new Vehiculos
            ...
            Marca ="Chevrolet_Corvette", Modelo ="Stingray Z51", Tipo ="Deportivo", Anio ="2020", Precio = 9000, Existencia = 5,},
            new Vehiculos
            ...
            Marca ="Mini", Modelo ="Cooper_Countryman", Tipo ="Coupé/Deportivo", Anio ="2016", Precio = 3000, Existencia = 5,},
        });
