...
public class Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vehiculos>().HasData(new List<Vehiculos>()
        {
            ...
            Marca ="Honda", Modelo ="CR-V", Tipo ="Jeepeta", Anio ="2021", Precio = 6745,},
            new Vehiculos
            ...
            Marca ="Honda", Modelo ="Civic", Tipo ="Sedán", Anio ="2022", Precio = 5340, },
            new Vehiculos
            ...
            Marca ="Mini", Modelo ="Cooper Countryman", Tipo ="Coupé/Deportivo", Anio ="2016", Precio = 3000,},
        });
    }
}